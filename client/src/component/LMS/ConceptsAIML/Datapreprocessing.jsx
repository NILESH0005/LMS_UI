...
const Datapreprocessing = () => {
    ...
    const DatapreprocessingFiles = [
        {
            
            title: "Research Paper",
            id: "1VnV1YaoqW_VAI84MPMLxj6ELA6P6C-lg",
            type: "pdf",
            description: ""
        },
        {
            ...
            title: "Workbook",
            id: "1xcsNsj4GIS6wCvmhQC0AnXIrVYbBuY4W",
            type: "notebook",
            downloadUrl: "https://drive.google.com/uc?export=download&id=1xcsNsj4GIS6wCvmhQC0AnXIrVYbBuY4W",
        ...
        },
        {
            ...
            title: "Dataset ",
            id: "1-D6zPe3MNr6FPlPe60F-tuM4awIzrjxf",
            type: "link",
            description: "",
             downloadUrl: "https://drive.google.com/uc?export=download&id=1-D6zPe3MNr6FPlPe60F-tuM4awIzrjxf"
    ...
    useEffect(() => {
        if (DatapreprocessingFiles.length > 0 && !selectedFile) {
            setSelectedFile(DatapreprocessingFiles[0]); // Default to first file
        }
    ...
    return (
        <div className="flex h-screen bg-gray-50 text-gray-800">
            ...
            <div className="w-64 bg-gray-800 text-white p-4 border-r border-gray-700 overflow-y-auto">
                <h2 className="text-xl font-bold mb-6 px-2">Data Preprocessing Resources</h2>
                <nav className="space-y-2">
                    {DatapreprocessingFiles.map(file => (
                        <button
                            key={file.id}
