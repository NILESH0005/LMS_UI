...
const Cnn = () => {
    ...
    const CnnFiles = [
        {
            ...
            id: "1tO6S08CtuHGp6zv3Fd9lFYvCuPVPYHPD",
            type: "pdf",
            description: ""
        },
        {
            
            title: "Types of CNN (Convolutional Neural Network",
            id: "1cE6ZHlkFQQxJTt42X5-HkzArt1CesHEm",
            type: "pdf",
            description: ""
        },
        {
            ...
            title: "Workbook",
            id: "1SmeF6KuhPUFrWqBHbm2_aQsWi2ZxqP6l",
            type: "notebook",
            downloadUrl: "https://drive.google.com/uc?export=download&id=1SmeF6KuhPUFrWqBHbm2_aQsWi2ZxqP6l",
    ...
    useEffect(() => {
        if (CnnFiles.length > 0 && !selectedFile) {
            setSelectedFile(CnnFiles[0]); // Default to first file
        }
    ...
    return (
        <div className="flex h-screen bg-gray-50 text-gray-800">
            ...
            <div className="w-64 bg-gray-800 text-white p-4 border-r border-gray-700 overflow-y-auto">
                <h2 className="text-xl font-bold mb-6 px-2">CNN Resources</h2>
