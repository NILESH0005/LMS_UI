...
const Rl = () => {
    ...
    const RlFiles = [
        {
            ...
            id: "1UES4h-Uo5fIKUURy4s5KIWNacb6WJVrK",
            type: "pdf",
            description: ""
        },
        {
            ...
            title: "Workbook",
            id: "1Zmp_7Kd_AuOLEb1ZxmAI-6LADJRRTRwQ",
            type: "notebook",
            downloadUrl: "https://drive.google.com/uc?export=download&id=1Zmp_7Kd_AuOLEb1ZxmAI-6LADJRRTRwQ",
    ...
    useEffect(() => {
        if (RlFiles.length > 0 && !selectedFile) {
            setSelectedFile(RlFiles[0]); // Default to first file
        }
    ...
    return (
        <div className="flex h-screen bg-gray-50 text-gray-800">
            ...
            <div className="w-64 bg-gray-800 text-white p-4 border-r border-gray-700 overflow-y-auto">
                <h2 className="text-xl font-bold mb-6 px-2">Reinforcement Learning Resources</h2>
