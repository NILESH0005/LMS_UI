...
const Opencv = () => {
    ...
    const OpencvFiles = [
        {
            ...
            id: "1l6Em5X0FeWmuvcgJpYWj1QDfXbLi6sr2",
            type: "pdf",
            description: ""
        },
        {
            ...
            title: "Workbook",
            id: "1_-ufSzyfDy3-sTjGE8NuKOAYKe0DGcL4",
            type: "notebook",
            downloadUrl: "https://drive.google.com/uc?export=download&id=1_-ufSzyfDy3-sTjGE8NuKOAYKe0DGcL4",
    ...
    useEffect(() => {
        if (OpencvFiles.length > 0 && !selectedFile) {
            setSelectedFile(OpencvFiles[0]); // Default to first file
        }
    ...
    return (
        <div className="flex h-screen bg-gray-50 text-gray-800">
            ...
            <div className="w-64 bg-gray-800 text-white p-4 border-r border-gray-700 overflow-y-auto">
                <h2 className="text-xl font-bold mb-6 px-2">OpenCV Resources</h2>
                <nav className="space-y-2">
                    {OpencvFiles.map(file => (
                        <button
                            key={file.id}
