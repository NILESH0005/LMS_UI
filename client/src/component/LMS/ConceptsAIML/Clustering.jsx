...
const Clustering = () => {
    ...
    const ClusteringFiles = [
      {
        ...
        id: "1qi7AZMDUGsmF8S6o_iFbRDuFfrh_-nSP",
        type: "pdf",
        description: ""
    },
    {
        ...
        title: "Workbook",
        id: "1uygNK4HRV8rXGxnnhlsYcSelAwPdwN6l",
        type: "notebook",
        downloadUrl: "https://drive.google.com/uc?export=download&id=1uygNK4HRV8rXGxnnhlsYcSelAwPdwN6l/",
    ...
    },
    {
        ...
        title: "Dataset ",
        id: "1QlRqyA0n99I_eW4LRCBDO0IinZMLjEBD",
        type: "link",
        description: "",
        downloadUrl: "https://drive.google.com/uc?export=download&id=1QlRqyA0n99I_eW4LRCBDO0IinZMLjEBD",
    ...
    useEffect(() => {
        if (ClusteringFiles.length > 0 && !selectedFile) {
            setSelectedFile(ClusteringFiles[0]); // Default to first file
        }
    ...
    return (
        <div className="flex h-screen bg-gray-50 text-gray-800">
            ...
            <div className="w-64 bg-gray-800 text-white p-4 border-r border-gray-700 overflow-y-auto">
                <h2 className="text-xl font-bold mb-6 px-2">Clustering Resources</h2>
                <nav className="space-y-2">
                    {ClusteringFiles.map(file => (
                        <button
                            key={file.id}
