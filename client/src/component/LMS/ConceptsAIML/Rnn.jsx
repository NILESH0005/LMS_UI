...
const Rnn = () => {
    ...
    const RnnFiles = [
        {
            ...
            id: "15VsfzIX0x2jARDTxhoZdM9ZrlpDC0aYV",
            type: "pdf",
            description: ""
        },
        {
            ...
            title: "Workbook",
            id: "1IYPEKQbkm8yqZYpt8-SuvZok2tQy-UA3",
            type: "notebook",
            downloadUrl: "https://drive.google.com/uc?export=download&id=1IYPEKQbkm8yqZYpt8-SuvZok2tQy-UA3",
    ...
    useEffect(() => {
        if (RnnFiles.length > 0 && !selectedFile) {
            setSelectedFile(RnnFiles[0]); // Default to first file
        }
    ...
    return (
        <div className="flex h-screen bg-gray-50 text-gray-800">
            ...
            <div className="w-64 bg-gray-800 text-white p-4 border-r border-gray-700 overflow-y-auto">
                <h2 className="text-xl font-bold mb-6 px-2">RNN Resources</h2>
