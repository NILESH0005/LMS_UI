...
const Lg7 = () => {
    ...
    const Lg7Files = [
        {
            id: "1FZZbMxUW75fOpv5LX4MCJaeCiUx-SOWM",
            title: "README",
            type: "pdf",
            ...
            id: "1LySC2OCdYXeXCsuLuq_QU8K66stg1YCM",
            title: "Workbook",
            type: "notebook",
            description: "",
            size: "",
            lastUpdated: "",
            downloadUrl: "https://drive.google.com/uc?export=download&id=1LySC2OCdYXeXCsuLuq_QU8K66stg1YCM",
            nbviewerUrl: "https://nbviewer.org/github/20maitrti/LMS/blob/main/car%20price%20prediction.ipynb"
        },
        {
            id: "1ww_RBpaD7QN3LJKdq3RPXQyawW_cvQNN",
            title: "Dataset",
            type: "csv",
            description: "",
            size: "",
            lastUpdated: "",
            downloadUrl: "https://drive.google.com/uc?export=download&id=1ww_RBpaD7QN3LJKdq3RPXQyawW_cvQNN"
        },
        {
            id: "assignment",
            title: "Assessment",
    ...
    useEffect(() => {
        if (Lg7Files.length > 0 && !selectedFile) {
            setSelectedFile(Lg7Files[0]); // Default to first file
        }
    ...
    return (
        <div className="flex h-screen bg-gray-50 text-gray-800">
            ...
            <div className="w-64 bg-gray-800 text-white p-4 border-r border-gray-700 overflow-y-auto">
                <h2 className="text-xl font-bold mb-6 px-2">Car Price Prediction Resources</h2>
