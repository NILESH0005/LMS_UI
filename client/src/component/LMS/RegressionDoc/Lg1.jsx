...
const Lg1 = () => {
    ...
    const Lg1Files = [
            // Previewable files (images)
            {
                id: "1kkvcjCy0E8XyrRUw08WBLMiMtLNhA5za",
                title: "homepricetable.jpg",
                type: "jpg",
                description: "",
                size: "",
                lastUpdated: "",
                previewUrl: "https://drive.google.com/file/d/1kkvcjCy0E8XyrRUw08WBLMiMtLNhA5za/preview"
            },
            {
                id: "1W27R7K25Tmmz1f2enxJ67M5sXyreac0z",
                title: "scatterplot.jpg",
                type: "jpg",
                description: "",
                size: "",
                lastUpdated: "",
                previewUrl: "https://drive.google.com/file/d/1W27R7K25Tmmz1f2enxJ67M5sXyreac0z/preview"
            },
            {
                ...
                size: "",
                lastUpdated: "",
                previewUrl: "https://drive.google.com/file/d/1-cuppr8xVrRpX5aFlQmBJ5nx_QPD1-Ti/preview"
            },
            {
                id: "1pBUM83NRcfPfIqC-0h_5lKbet7x1fAjb",
                title: "linear_equation.png",
                type: "png",
                description: "",
                size: "",
                lastUpdated: "",
                previewUrl: "https://drive.google.com/file/d/1pBUM83NRcfPfIqC-0h_5lKbet7x1fAjb/preview"
            },
            ...
            // Non-previewable files (notebooks, CSVs)
            {
                ...
                size: "",
                lastUpdated: "",
                downloadUrl: "https://drive.google.com/uc?export=download&id=15IH_YfX1UCl64CB_z-dp7QhanoLASn3n"
            },
            {
                ...
                size: "",
                lastUpdated: "",
                downloadUrl: "https://drive.google.com/uc?export=download&id=1nE6UJCWpasW-RppS0PTjj7BMSfW6_OmH"
            },
            {
                ...
                size: "",
                lastUpdated: "",
                downloadUrl: "https://drive.google.com/uc?export=download&id=1VQGrBoSmHiW0HOe1t6MRuuBRA6yAps4y"
            }
    ];

    useEffect(() => {
        if (Lg1Files.length > 0 && !selectedFile) {
            setSelectedFile(Lg1Files[0]); // Default to first file
        }
    ...
    const handleFeedbackSubmit = (rating, comment) => {
        ...
        localStorage.setItem("Lg1Feedback", JSON.stringify(updatedFeedback));
    ...
    return (
        <div className="flex h-screen bg-gray-50 text-gray-800">
            ...
            <div className="w-64 bg-gray-800 text-white p-4 border-r border-gray-700 overflow-y-auto">
                <h2 className="text-xl font-bold mb-6 px-2">Home Price Prediction-Single Variable Resources</h2>
