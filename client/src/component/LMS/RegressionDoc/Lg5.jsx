...
const Lg5 = () => {
    ...
    const Lg5Files = [
       
        {
            ...
            nbviewerUrl: "https://nbviewer.org/github/20maitrti/LMS/blob/main/Linear%20Regression%20Multivariate%202%20.ipynb"
        },
        {
    ...
    useEffect(() => {
        if (Lg5Files.length > 0 && !selectedFile) {
            setSelectedFile(Lg5Files[0]); // Default to first file
        }
    ...
    return (
        <div className="flex h-screen bg-gray-50 text-gray-800">
            ...
            <div className="w-64 bg-gray-800 text-white p-4 border-r border-gray-700 overflow-y-auto">
                <h2 className="text-xl font-bold mb-6 px-2">Salary Prediction using Linear Regression Resources</h2>
