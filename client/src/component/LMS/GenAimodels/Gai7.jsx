...
const Gai7 = () => {
    ...
    const Gai7Files = [
        {
            ...
            title: "Workbook",
            id: "1ErJ01dNkASjue2svCIP8u2UJBkZkSm7W", 
            type: "notebook",
            description: "",
            downloadUrl: "https://drive.google.com/uc?export=download&id=1ErJ01dNkASjue2svCIP8u2UJBkZkSm7W"
        },
        {
          title: "Assesment",
            type: "assessment"
    ...
    useEffect(() => {
        if (Gai7Files.length > 0 && !selectedFile) {
            setSelectedFile(Gai7Files[0]); // Default to first file
        }
    ...
    return (
        <div className="flex h-screen bg-gray-50 text-gray-800">
            ...
            <div className="w-64 bg-gray-800 text-white p-4 border-r border-gray-700 overflow-y-auto">
                <h2 className="text-xl font-bold mb-6 px-2">Stable Diffusion - Text to Image Resources</h2>
