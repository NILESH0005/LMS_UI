...
const Gai2 = () => {
    ...
    const Gai2Files = [
        {
            ...
            title: "Workbook",
            id: "14Vo3UYc2iLTCnoWcII_8vBCqJCEIciGi", 
            type: "notebook",
            description: "",
            downloadUrl: "https://drive.google.com/uc?export=download&id=14Vo3UYc2iLTCnoWcII_8vBCqJCEIciGi"
        },
        {
          title: "Assesment",
            type: "assessment"
    ...
    useEffect(() => {
        if (Gai2Files.length > 0 && !selectedFile) {
            setSelectedFile(Gai2Files[0]); // Default to first file
        }
    ...
    return (
        <div className="flex h-screen bg-gray-50 text-gray-800">
            ...
            <div className="w-64 bg-gray-800 text-white p-4 border-r border-gray-700 overflow-y-auto">
                <h2 className="text-xl font-bold mb-6 px-2">LLaMA 2 Fine-Tuning Resources</h2>
