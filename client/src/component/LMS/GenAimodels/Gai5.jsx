...
const Gai5 = () => {
    ...
    const Gai5Files = [
        {
            ...
            title: "Workbook",
            id: "1kEFLmkrc7xShThwJmf6nf6Cz2y7QpTMn", 
            type: "notebook",
            description: "",
            downloadUrl: "https://drive.google.com/uc?export=download&id=1kEFLmkrc7xShThwJmf6nf6Cz2y7QpTMn"
        },
        {
          title: "Assesment",
            type: "assessment"
    ...
    useEffect(() => {
        if (Gai5Files.length > 0 && !selectedFile) {
            setSelectedFile(Gai5Files[0]); // Default to first file
        }
    ...
    return (
        <div className="flex h-screen bg-gray-50 text-gray-800">
            ...
            <div className="w-64 bg-gray-800 text-white p-4 border-r border-gray-700 overflow-y-auto">
                <h2 className="text-xl font-bold mb-6 px-2">Summarization with T5 & BART Resources</h2>
