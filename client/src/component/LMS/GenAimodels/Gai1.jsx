...
const Gai1 = () => {
    ...
    const Gai1Files = [
        {
            ...
            title: "Workbook",
            id: "rODEAoxxMSyIzesjIoWN3RcG2srXs13Q", 
            type: "notebook",
            description: "",
            downloadUrl: "https://drive.google.com/uc?export=download&id=rODEAoxxMSyIzesjIoWN3RcG2srXs13Q"
        },
        {
          title: "Assesment",
            type: "assessment"
    ...
    useEffect(() => {
        if (Gai1Files.length > 0 && !selectedFile) {
            setSelectedFile(Gai1Files[0]); // Default to first file
        }
    ...
    return (
        <div className="flex h-screen bg-gray-50 text-gray-800">
            ...
            <div className="w-64 bg-gray-800 text-white p-4 border-r border-gray-700 overflow-y-auto">
                <h2 className="text-xl font-bold mb-6 px-2">CLIP Model Tuning Resources</h2>
