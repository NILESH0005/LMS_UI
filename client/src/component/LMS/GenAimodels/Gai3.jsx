...
const Gai3 = () => {
    ...
    const Gai3Files = [
        {
            ...
            title: "Workbook",
            id: "1t5XvKkzKboRiyvvI9hWXPW7M9t3IFQar", 
            type: "notebook",
            description: "",
            downloadUrl: "https://drive.google.com/uc?export=download&id=1t5XvKkzKboRiyvvI9hWXPW7M9t3IFQar"
        },
        {
          title: "Assesment",
            type: "assessment"
    ...
    useEffect(() => {
        if (Gai3Files.length > 0 && !selectedFile) {
            setSelectedFile(Gai3Files[0]); // Default to first file
        }
    ...
    return (
        <div className="flex h-screen bg-gray-50 text-gray-800">
            ...
            <div className="w-64 bg-gray-800 text-white p-4 border-r border-gray-700 overflow-y-auto">
                <h2 className="text-xl font-bold mb-6 px-2">Phi-1.5 Model Fine-Tuning Resources</h2>
