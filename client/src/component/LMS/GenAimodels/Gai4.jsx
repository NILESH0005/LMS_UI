...
const Gai4 = () => {
    ...
    const Gai4Files = [
        {
            ...
            title: "Workbook",
            id: "1qN4DRIGMDjNhENYSoTKQ9jG-nBQQty36", 
            type: "notebook",
            description: "",
            downloadUrl: "https://drive.google.com/uc?export=download&id=1qN4DRIGMDjNhENYSoTKQ9jG-nBQQty36"
        },
        {
          title: "Assesment",
            type: "assessment"
    ...
    useEffect(() => {
        if (Gai4Files.length > 0 && !selectedFile) {
            setSelectedFile(Gai4Files[0]); // Default to first file
        }
    ...
    return (
        <div className="flex h-screen bg-gray-50 text-gray-800">
            ...
            <div className="w-64 bg-gray-800 text-white p-4 border-r border-gray-700 overflow-y-auto">
                <h2 className="text-xl font-bold mb-6 px-2">Mistral 7B Fine-Tuning Resources</h2>
