...
const Gai6 = () => {
    ...
    const Gai6Files = [
        {
            ...
            title: "Workbook",
            id: "1eg-709n7epGGJMNN7M26ZkPuQgWJ2Bhi", 
            type: "notebook",
            description: "",
            downloadUrl: "https://drive.google.com/uc?export=download&id=1eg-709n7epGGJMNN7M26ZkPuQgWJ2Bhi"
        },
        {
          title: "Assesment",
            type: "assessment"
    ...
    useEffect(() => {
        if (Gai6Files.length > 0 && !selectedFile) {
            setSelectedFile(Gai6Files[0]); // Default to first file
        }
    ...
    return (
        <div className="flex h-screen bg-gray-50 text-gray-800">
            ...
            <div className="w-64 bg-gray-800 text-white p-4 border-r border-gray-700 overflow-y-auto">
                <h2 className="text-xl font-bold mb-6 px-2">GPT-2 Fine-Tuning Resources</h2>
