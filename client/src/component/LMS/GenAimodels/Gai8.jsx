...
const Gai8 = () => {
    ...
    const Gai8Files = [
        {
            ...
            title: "Workbook",
            id: "1UBwieFaFx0jcA3QZKFUY3agboVPgrjwT", 
            type: "notebook",
            description: "",
            downloadUrl: "https://drive.google.com/uc?export=download&id=1UBwieFaFx0jcA3QZKFUY3agboVPgrjwT"
        },
        {
          title: "Assesment",
            type: "assessment"
    ...
    useEffect(() => {
        if (Gai8Files.length > 0 && !selectedFile) {
            setSelectedFile(Gai8Files[0]); // Default to first file
        }
    ...
    return (
        <div className="flex h-screen bg-gray-50 text-gray-800">
            ...
            <div className="w-64 bg-gray-800 text-white p-4 border-r border-gray-700 overflow-y-auto">
                <h2 className="text-xl font-bold mb-6 px-2">TinyLlama Fine-Tuning Resources</h2>
