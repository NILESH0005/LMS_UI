...
const GradientDescent = () => {
    ...
    const GradientDescentFiles = [
        {
            id: "1XKj7oJyZh6P3lzhsT6bwxZ0uC2I-Maaj",
            title: "Published Paper",
            type: "pdf",
            description: "A theoretical and practical guide to Gradient Descent, covering different variants such as Batch, Stochastic, and Mini-batch gradient descent. Explains convergence properties, learning rates, and cost function optimization.",
            size: "2.3MB",
            lastUpdated: "2024-03-10"
        },
        {
            id: "1Nmp9Nd1-9wtJCXPx6S2V94-7ukWc8jNh",
            title: "Workbook",
            type: "notebook",
            description: "A Jupyter notebook that explains and demonstrates the Gradient Descent optimization algorithm with step-by-step visualizations and mathematical derivations, including implementations in Python. ",
            size: "3.1MB",
            lastUpdated: "2024-03-15",
            downloadUrl: "https://drive.google.com/uc?export=download&id=1Nmp9Nd1-9wtJCXPx6S2V94-7ukWc8jNh"
        }
    ];

    useEffect(() => {
        if (GradientDescentFiles.length > 0 && !selectedFile) {
            setSelectedFile(GradientDescentFiles[0]); // Default to first file
        }
    ...
    return (
        <div className="flex h-screen bg-gray-50 text-gray-800">
            ...
            <div className="w-64 bg-gray-800 text-white p-4 border-r border-gray-700 overflow-y-auto">
                <h2 className="text-xl font-bold mb-6 px-2">Gradient Descent Resources</h2>
                <nav className="space-y-2">
                    {GradientDescentFiles.map(file => (
                        <button
                            key={file.id}
