...
const Lstm = () => {
    ...
    const LstmFiles = [
        {
            ...
            title: "Guide",
            id: "1MlevLDVAhVMwVH4iiWzCMJF6orcpMhUq",
            type: "pdf",
            description: "A comprehensive guide on Long Short-Term Memory (LSTM) networks, explaining their internal architecture, gating mechanisms, and applications in time series prediction and natural language processing. Includes mathematical formulations and training dynamics",

        },
        {
         
            title: "Workbook",
            id: "10FugrkH7XCeSEI2SvuKV6MJqxMLzHdcz",
            type: "notebook",
            description: "This notebook provides an implementation and explanation of Long Short-Term Memory (LSTM) networks, commonly used for sequential data such as time series or natural language. It includes training and evaluation on example datasets.",
             downloadUrl: "https://drive.google.com/uc?export=download&id=10FugrkH7XCeSEI2SvuKV6MJqxMLzHdcz"
        },
        {
    ...
    useEffect(() => {
        if (LstmFiles.length > 0 && !selectedFile) {
            setSelectedFile(LstmFiles[0]); // Default to first file
        }
