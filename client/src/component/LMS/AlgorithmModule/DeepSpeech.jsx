         ...
         
{
    ...
    title: "Guide",
    id: "1hUz_72VxUZmQNW2Pyd0-GrgjBWNEwlqJ",
    type: "pdf",
 
    description: "An in-depth document explaining Mozilla's DeepSpeech speech-to-text engine based on Baidu's Deep Speech research. Covers the model architecture using RNNs, training and inference workflows, evaluation metrics (WER and CER), hardware requirements, and supported audio formats."
},
{
   
    title: "Workbook",
    id: "1TrikRjxiop2kQ_xQye1H06HYy8Pz0V_o",
    type: "notebook",
    
    description: "Jupyter notebook with DeepSpeech implementation",
    downloadUrl: "https://drive.google.com/uc?export=download&id=1TrikRjxiop2kQ_xQye1H06HYy8Pz0V_o"
},
{
    ...
    useEffect(() => {
        if ( DeepSpeechFiles.length > 0 && !selectedFile) {
            setSelectedFile( DeepSpeechFiles[0]); // Default to first file
        }
        ...
        return (
            <div className="flex flex-col items-center justify-center h-full border rounded-xl shadow-lg bg-white p-8">
                <div className="text-center max-w-md">
                    ...
                    <p className="text-gray-500 mb-4">This notebook showcases the DeepSpeech model, a deep learning-based speech-to-text system. It includes audio preprocessing, model usage, and decoding of speech inputs into text.</p>
                    <button
    ...
    return (
        <div className="flex h-screen bg-gray-50 text-gray-800">
            ...
            <div className="w-64 bg-gray-800 text-white p-4 border-r border-gray-700 overflow-y-auto">
                <h2 className="text-xl font-bold mb-6 px-2">DeepSpeech Resources</h2>
