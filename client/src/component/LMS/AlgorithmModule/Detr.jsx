...
const Detr = () => {
    ...
    const DetrFiles = [
        {
            ...
            title: "Guide",
            id: "1qSi67nkaGrnkXPIvCZHqUxDMwhPGO3tu",
            type: "pdf",
            description: "An in-depth explanation of Facebook AI’s DETR (DEtection TRansformer) model for object detection. Discusses its transformer-based architecture, attention mechanisms, training strategy, and performance benchmarks compared to traditional detectors."
        },
        {
           
            title: "Workbook",
            id: "1dR2mZcLsf0ynDAln4DtzI3_p2BDCtKw8",
            type: "notebook",
            description: "Jupyter notebook with DETR implementation",
            downloadUrl: "https://drive.google.com/uc?export=download&id=1dR2mZcLsf0ynDAln4DtzI3_p2BDCtKw8"
        },
        {
            id: 3,
            title: "Assessment",
    ...
    useEffect(() => {
        if (DetrFiles.length > 0 && !selectedFile) {
            setSelectedFile(DetrFiles[0]); // Default to first file
        }
        ...
        return (
            <div className="flex flex-col items-center justify-center h-full border rounded-xl shadow-lg bg-white p-8">
                <div className="text-center max-w-md">
                    ...
                    <p className="text-gray-500 mb-4">An example notebook demonstrating the use of DETR (DEtection TRansformer), including model architecture overview, inference on sample images, and visualization of object detection results.</p>
                    <button
    ...
    return (
        <div className="flex h-screen bg-gray-50 text-gray-800">
            ...
            <div className="w-64 bg-gray-800 text-white p-4 border-r border-gray-700 overflow-y-auto">
                <h2 className="text-xl font-bold mb-6 px-2">DETR Resources</h2>
