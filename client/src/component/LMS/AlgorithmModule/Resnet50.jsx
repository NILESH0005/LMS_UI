    ...
    const Resnet50Files = [
        {
            ...
            title: "Guide",
            id: "1GWAmSutHzKjJvTVun9VLLrOjubaIwqOk",
            type: "pdf",
            description: "An analytical overview of the ResNet50 architecture, introducing residual connections, identity mapping, and vanishing gradient solutions. Covers training tips, layer-by-layer breakdown, and use in image classification tasks."
        },
        {
            
            title: "Workbook",
            id: "1WQaIchi7RaepQL9dLSunE_383JA2v8JJ",
            type: "notebook",
            description: "A Jupyter notebook that implements and explains ResNet50, a deep convolutional neural network known for its residual connections. Includes model architecture, transfer learning, and image classification examples.",
             downloadUrl: "https://drive.google.com/uc?export=download&id=1WQaIchi7RaepQL9dLSunE_383JA2v8JJ"
        },
        {
          
            title: "Assessment",
            type: "assessment",
            description: "Test your knowledge about ResNet50"
        }
    ];

    useEffect(() => {
        if (Resnet50Files.length > 0 && !selectedFile) {
            setSelectedFile(Resnet50Files[0]); // Default to first file
        }
    ...
    return (
        <div className="flex h-screen bg-gray-50 text-gray-800">
            ...
            <div className="w-64 bg-gray-800 text-white p-4 border-r border-gray-700 overflow-y-auto">
                <h2 className="text-xl font-bold mb-6 px-2">Resnet50 Resources</h2>
                <nav className="space-y-2">
                    {Resnet50Files.map(file => (
                        <button
                            key={file.id}
