...
const Efficientnet = () => {
    ...
    const EfficientnetFiles = [
        {
            id: "1Y_iw6Gb56Uk0fRBl9xU6sMcNp4izb4zp",
            title: "",
            type: "pdf",
            description: "",
            size: "2.3MB",
        ...
        {
            id: "1wuL7oXq7E5Hr235_53BVnOpaYG-DYUqa",
            title: "",
            type: "notebook",
            description: " ",
            size: "3.1MB",
            lastUpdated: "2024-03-15",
            downloadUrl: "https://drive.google.com/uc?export=download&id=1wuL7oXq7E5Hr235_53BVnOpaYG-DYUqa"
        }
    ];

    useEffect(() => {
        if (EfficientnetFiles.length > 0 && !selectedFile) {
            setSelectedFile(EfficientnetFiles[0]); // Default to first file
        }
    ...
    const handleFeedbackSubmit = (rating, comment) => {
        ...
        localStorage.setItem("EfficientnetFeedback", JSON.stringify(updatedFeedback));
