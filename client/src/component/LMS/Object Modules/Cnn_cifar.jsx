...
const Cnn_cifar = () => {
    ...
    const Cnn_cifarFiles = [
        ...
        //     downloadUrl: "https://drive.google.com/uc?export=download&id=1SPL5C6PSANGTKw06c3ix2ft3gMVe1JWU"
        // }
        {
    ...
    return (
        <div className="flex h-screen bg-gray-50 text-gray-800">
            ...
            <div className="w-64 bg-gray-800 text-white p-4 border-r border-gray-700 overflow-y-auto">
                <h2 className="text-xl font-bold mb-6 px-2">CNN-CIFAR-10 Resources</h2>
