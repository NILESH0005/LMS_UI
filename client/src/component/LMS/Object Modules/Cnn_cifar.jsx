...
const Cnn_cifar = () => {
    ...
    const Cnn_cifarFiles = [
        {
            id: "1ppTHlb3gCx-u1C1dbnajiFHqBgm8U7eN",
            title: "small_images.jpg",
            type: "jpg",
            description: "",
            size: "2.3MB",
        ...
        {
            id: "1CrpMkrIK07vGbc8IDFvQwNaWFF2wxgjz",
            title: "cnn_cifar10_dataset.ipynb",
            type: "notebook",
            description: " ",
            size: "3.1MB",
            lastUpdated: "2024-03-15",
            downloadUrl: "https://drive.google.com/uc?export=download&id=1CrpMkrIK07vGbc8IDFvQwNaWFF2wxgjz"
        }
    ];

    useEffect(() => {
        if (Cnn_cifarFiles.length > 0 && !selectedFile) {
            setSelectedFile(Cnn_cifarFiles[0]); // Default to first file
        }
    ...
    const handleFeedbackSubmit = (rating, comment) => {
        ...
        localStorage.setItem("Cnn_cifarFeedback", JSON.stringify(updatedFeedback));
