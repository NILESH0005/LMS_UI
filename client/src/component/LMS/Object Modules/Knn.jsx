...
const Knn = () => {
    ...
    useEffect(() => {
        if (KnnFiles.length > 0 && !selectedFile) {
            setSelectedFile(KnnFiles[0]); // Default to first file
        }
    ...
    const handleFeedbackSubmit = (rating, comment) => {
        ...
        localStorage.setItem("KnnFeedback", JSON.stringify(updatedFeedback));
    ...
    return (
        <div className="flex h-screen bg-gray-50 text-gray-800">
            ...
            <div className="w-64 bg-gray-800 text-white p-4 border-r border-gray-700 overflow-y-auto">
                <h2 className="text-xl font-bold mb-6 px-2">KNN Resources</h2>
