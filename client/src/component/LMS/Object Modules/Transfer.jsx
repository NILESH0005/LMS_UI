...
const Transfer = () => {
    ...
    const TransferFiles = [
        {
            id: "1Qg9_HrF50nMM-ZldfvR8fFsXIlWdnbUy",
            title: "README",
            type: "pdf",
        ...
        {
            "id": "1k87GFzeWQvmI1rncUzE8EESevYmNdPk4",
            "title": "Workbook",
            "type": "notebook",
            "description": ".",
            "size": "3.1MB",
            "lastUpdated": "2024-03-15",
            "downloadUrl": "https://drive.google.com/uc?export=download&id=1k87GFzeWQvmI1rncUzE8EESevYmNdPk4"
          },
          {
            "id": "1a8rEDv5MDwdc9iMa3S48LBk_qsKRnYYE",
            "title": "Labels",
            "type": "zip",
            "description": ".",
            "downloadUrl": "https://drive.google.com/uc?export=download&id=1a8rEDv5MDwdc9iMa3S48LBk_qsKRnYYE"
          },
          {
            "id": "1ZNPnC5g7pEqxl0t_9I2F0hh7CqojNJLs",
            "title": "Test Image",
            "type": "jpg",
    ...
    useEffect(() => {
        if (TransferFiles.length > 0 && !selectedFile) {
            setSelectedFile(TransferFiles[0]); // Default to first file
        }
