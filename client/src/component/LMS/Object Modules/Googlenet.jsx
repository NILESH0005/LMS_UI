...
const Googlenet = () => {
    ...
    useEffect(() => {
        if (GooglenetFiles.length > 0 && !selectedFile) {
            setSelectedFile(GooglenetFiles[0]); // Default to first file
        }
    ...
    const handleFeedbackSubmit = (rating, comment) => {
        ...
        localStorage.setItem("GooglenetFeedback", JSON.stringify(updatedFeedback));
