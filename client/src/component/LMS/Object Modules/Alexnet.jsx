...
const Alexnet = () => {
    ...
    const AlexnetFiles = [
        {
            id: "1QJQgFdKo_YxLztAmROc_93iQUwsOFV4F",
            title: "",
            type: "pdf",
            description: "",
            size: "2.3MB",
        ...
        {
            id: "1i40UTNJjNEhjX2FzGtRPkRcAw5ED92S5",
            title: "",
            type: "notebook",
            description: " ",
            size: "3.1MB",
            lastUpdated: "2024-03-15",
            downloadUrl: "https://drive.google.com/uc?export=download&id=1i40UTNJjNEhjX2FzGtRPkRcAw5ED92S5"
        }
    ];

    useEffect(() => {
        if (AlexnetFiles.length > 0 && !selectedFile) {
            setSelectedFile(AlexnetFiles[0]); // Default to first file
        }
    ...
    const handleFeedbackSubmit = (rating, comment) => {
        ...
        localStorage.setItem("AlexnetFeedback", JSON.stringify(updatedFeedback));
