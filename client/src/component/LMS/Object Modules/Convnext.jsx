...
const Convnext = () => {
    ...
    const ConvnextFiles = [
        {
            id: "1fDdUUeaof_rZRALtN6ZfYirISpJJRJ4U",
        ...
        {
            id: "1m9qlILHNcNiqNAbd6ruWYyZfPgYDxpVa",
            title: "Workbook",
            type: "notebook",
            description: " ",
            size: "3.1MB",
            lastUpdated: "2024-03-15",
            downloadUrl: "https://drive.google.com/uc?export=download&id=1m9qlILHNcNiqNAbd6ruWYyZfPgYDxpVa"
        },
        {
            id: "assignment",
            title: "Assessment",
    ...
    useEffect(() => {
        if (ConvnextFiles.length > 0 && !selectedFile) {
            setSelectedFile(ConvnextFiles[0]); // Default to first file
        }
    ...
    const handleFeedbackSubmit = (rating, comment) => {
        ...
        localStorage.setItem("ConvnextFeedback", JSON.stringify(updatedFeedback));
    ...
    return (
        <div className="flex h-screen bg-gray-50 text-gray-800">
            ...
            <div className="w-64 bg-gray-800 text-white p-4 border-r border-gray-700 overflow-y-auto">
                <h2 className="text-xl font-bold mb-6 px-2">ConvNeXt Resources</h2>
                <nav className="space-y-2">
                    {ConvnextFiles.map(file => (
                        <button
                            key={file.id}
