...
const Faster_rcnn = () => {
    ...
    const Faster_rcnnFiles = [
        {
        
            title: "Research Paper",
            id: "1vYLsVq8Wg23hZcy6vafUANEgD8s_JDcF", // Replace with actual PDF ID
            type: "pdf",
            description: "Introduces Faster R-CNN, a two-stage object detection framework that integrates Region Proposal Networks (RPNs) to eliminate the need for external proposal generation. It achieves near real-time detection with high accuracy on benchmarks like PASCAL VOC and MS COCO."
        },
        {
            
            title: "Workbook",
            id: "1fwWd58YFeo2MA_vWJXdG3YDN9wyYc072", // Replace with actual notebook ID
            type: "notebook",
            description: "Practical implementation of Faster R-CNN model",
            downloadUrl: "https://drive.google.com/uc?export=download&id=1fwWd58YFeo2MA_vWJXdG3YDN9wyYc072"
        },
    ...
    useEffect(() => {
        if (Faster_rcnnFiles.length > 0 && !selectedFile) {
            setSelectedFile(Faster_rcnnFiles[0]); // Default to first file
        }
    ...
    return (
        <div className="flex h-screen bg-gray-50 text-gray-800">
            ...
            <div className="w-64 bg-gray-800 text-white p-4 border-r border-gray-700 overflow-y-auto">
                <h2 className="text-xl font-bold mb-6 px-2">Faster R-CNN Resources</h2>
                <nav className="space-y-2">
                    {Faster_rcnnFiles.map(file => (
                        <button
                            key={file.id}
