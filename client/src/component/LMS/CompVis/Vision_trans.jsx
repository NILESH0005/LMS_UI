...
const Vision_trans = () => {
    ...
    const Vision_transFiles = [
        {
           
            title: "Research Paper",
            id: "1mPmZxyIz6thOW6cPE5GraqeOQHbfMSQ-", // Replace with actual PDF ID
            type: "pdf",
            description: "Introduces Vision Transformer (ViT), a pure Transformer-based model for image classification that processes images as sequences of patches. The guide highlights ViT's performance when pre-trained on large datasets and its competitive accuracy compared to state-of-the-art CNNs, especially on benchmarks like ImageNet and CIFAR-100."
        },
        {
            
            title: "Workbook",
            id: "1RDzc7lpfOhU3QO_QdkpuPrbvFCUrFwzY", // Replace with actual notebook ID
            type: "notebook",
            description: "This notebook covers the fundamentals and implementation of Vision Transformers (ViTs), a deep learning architecture that applies transformer models to image classification tasks. It includes code for model definition, training, and evaluation.",
            downloadUrl: "https://drive.google.com/uc?export=download&id=1RDzc7lpfOhU3QO_QdkpuPrbvFCUrFwzY"
        },
        {
           title: "Assesment",
            type: "assessment"
    ...
    useEffect(() => {
        if (Vision_transFiles.length > 0 && !selectedFile) {
            setSelectedFile(Vision_transFiles[0]); // Default to first file
        }
    ...
    return (
        <div className="flex h-screen bg-gray-50 text-gray-800">
            ...
            <div className="w-64 bg-gray-800 text-white p-4 border-r border-gray-700 overflow-y-auto">
                <h2 className="text-xl font-bold mb-6 px-2">Vision Transformer Resources</h2>
                <nav className="space-y-2">
                    {Vision_transFiles.map(file => (
                        <button
                            key={file.id}
