...
const Mask_Rcnn = () => {
    ...
    const Mask_RcnnFiles = [
    {
            title: "Research Paper",
            id: "1h006cDLpA9ZUJJWsJA2bIbVNjylM1c0F", // Replace with actual PDF ID
            type: "pdf",
            description: "Explains Mask R-CNN, an extension of Faster R-CNN that adds a parallel branch for pixel-level instance segmentation. It achieves high-quality object detection and mask generation while maintaining fast inference speeds, and is easily generalizable to tasks like human pose estimation."
        },
        {
            
            title: "Workbook",
            id: "1TvTnkt0rl5zaXkX453pnF4GkB6sa7AHp", // Replace with actual notebook ID
            type: "notebook",
            description: "Practical implementation of Mask R-CNN model",
             downloadUrl: "https://drive.google.com/uc?export=download&id=1TvTnkt0rl5zaXkX453pnF4GkB6sa7AHp"
        },
        {
    ...
    useEffect(() => {
        if (Mask_RcnnFiles.length > 0 && !selectedFile) {
            setSelectedFile(Mask_RcnnFiles[0]); // Default to first file
        }
    ...
    return (
        <div className="flex h-screen bg-gray-50 text-gray-800">
            ...
            <div className="w-64 bg-gray-800 text-white p-4 border-r border-gray-700 overflow-y-auto">
                <h2 className="text-xl font-bold mb-6 px-2">Mask R-CNN Resources</h2>
                <nav className="space-y-2">
                    {Mask_RcnnFiles.map(file => (
                        <button
                            key={file.id}
