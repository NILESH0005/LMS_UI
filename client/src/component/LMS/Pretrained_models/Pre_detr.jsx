...
const Pre_detr = () => {
    ...
    useState(() => {
        if (preDetrFiles.length > 0 && !selectedFileId) {
            setSelectedFileId(preDetrFiles[0].fileId);
            setSelectedFileName(preDetrFiles[0].title);
            setSelectedFileType(preDetrFiles[0].type);
        }
    ...
    const renderFileContent = () => {
        ...
        const currentFile = preDetrFiles.find(f => f.fileId === selectedFileId);
            ...
            case "tar":
                return (
                    <div className="flex flex-col items-center justify-center h-full p-8 text-center">
                        ...
                        <button
                            onClick={() => handleDownload(currentFile.fileId, currentFile.title, "tar")}
    ...
    return (
        <div className="flex h-screen bg-background text-foreground">
            ...
            <div className="w-64 bg-gray-800 text-white p-4 border-r border-gray-700">
                <h2 className="text-xl font-bold mb-6">Pre-DETR Resources</h2>
            ...
            <div className="flex-1 flex flex-col p-6">
                <div className="mb-6">
                    ...
                    <p className="text-gray-600 mt-2">
                        {preDetrFiles.find(f => f.fileId === selectedFileId)?.description || ""}
                    </p>
                </div>
...
const sendFeedbackToServer = (feedback) => {
    ...
    console.log("Submitting Pre-DETR feedback:", feedback);
