...
const Pre_densenet = () => {
    ...
    const Pre_densenetFiles = [
      {
        id: "1_LzQ6-cBYD_wZNYWQusM6W4_zXaIvtDm",
    ...
    {
        id: "1HlQf4txiby6_D6rfSQKLjnVEkyesAc6U",
        title: "Workbook",
        type: "notebook",
        description: " ",
        size: "3.1MB",
        lastUpdated: "2024-03-15",
        downloadUrl: "https://drive.google.com/uc?export=download&id=1HlQf4txiby6_D6rfSQKLjnVEkyesAc6U"
    }
    ];

    useEffect(() => {
        if (Pre_densenetFiles.length > 0 && !selectedFile) {
            setSelectedFile(Pre_densenetFiles[0]); // Default to first file
        }
    ...
    const handleFeedbackSubmit = (rating, comment) => {
        ...
        localStorage.setItem("Pre_densenetFeedback", JSON.stringify(updatedFeedback));
    ...
    return (
        <div className="flex h-screen bg-gray-50 text-gray-800">
            ...
            <div className="w-64 bg-gray-800 text-white p-4 border-r border-gray-700 overflow-y-auto">
                <h2 className="text-xl font-bold mb-6 px-2">DenseNet Resources</h2>
                <nav className="space-y-2">
                    {Pre_densenetFiles.map(file => (
                        <button
                            key={file.id}
