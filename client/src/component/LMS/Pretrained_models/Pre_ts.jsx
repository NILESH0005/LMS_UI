...
const Pre_ts = () => {
    ...
    const Pre_tsFiles = [
      {
        id: "1k2oFsIZuvQL8MkrniRekgMhUhBByCs3N",
    ...
    {
        id: "1XWeAgV5TiyD8CE2MNtK2-fet7cY-IfEr",
        title: "Workbook",
        type: "notebook",
        description: " ",
        size: "3.1MB",
        lastUpdated: "2024-03-15",
        downloadUrl: "https://drive.google.com/uc?export=download&id=1XWeAgV5TiyD8CE2MNtK2-fet7cY-IfEr"
    }
    ];

    useEffect(() => {
        if (Pre_tsFiles.length > 0 && !selectedFile) {
            setSelectedFile(Pre_tsFiles[0]); // Default to first file
        }
    ...
    const handleFeedbackSubmit = (rating, comment) => {
        ...
        localStorage.setItem("Pre_tsFeedback", JSON.stringify(updatedFeedback));
    ...
    return (
        <div className="flex h-screen bg-gray-50 text-gray-800">
            ...
            <div className="w-64 bg-gray-800 text-white p-4 border-r border-gray-700 overflow-y-auto">
                <h2 className="text-xl font-bold mb-6 px-2">T5 Resources</h2>
                <nav className="space-y-2">
                    {Pre_tsFiles.map(file => (
                        <button
                            key={file.id}
