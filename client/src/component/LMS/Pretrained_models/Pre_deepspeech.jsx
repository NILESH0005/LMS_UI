...
const Pre_deepspeech = () => {
    ...
    const Pre_deepspeechFiles = [
        
{
   
    title: "Research Paper",
    id: "1q4gPAu6jj03aleNUrc86rSOs1i_pnNAf", // Replace with actual PDF ID
    type: "pdf",
...
},
{
    ...
    useEffect(() => {
        if (Pre_deepspeechFiles.length > 0 && !selectedFile) {
            setSelectedFile(Pre_deepspeechFiles[0]); // Default to first file
        }
    ...
    return (
        <div className="flex h-screen bg-gray-50 text-gray-800">
            ...
            <div className="w-64 bg-gray-800 text-white p-4 border-r border-gray-700 overflow-y-auto">
                <h2 className="text-xl font-bold mb-6 px-2">Deep Speech Resources</h2>
                <nav className="space-y-2">
                    {Pre_deepspeechFiles.map(file => (
                        <button
                            key={file.id}
