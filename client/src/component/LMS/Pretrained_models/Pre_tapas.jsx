...
const Pre_tapas = () => {
    ...
    const Pre_tapasFiles = [
      {
        id: "1l1RWjQpWGGlzucAGdma2JjV_59ALOXYl",
    ...
    {
        id: "1lzyR5GrKwLW5692alqfyW0-3WDT_5Dv0",
        title: "Workbook",
        type: "notebook",
        description: " ",
        size: "3.1MB",
        lastUpdated: "2024-03-15",
        downloadUrl: "https://drive.google.com/uc?export=download&id=1lzyR5GrKwLW5692alqfyW0-3WDT_5Dv0"
    }
    ];

    useEffect(() => {
        if (Pre_tapasFiles.length > 0 && !selectedFile) {
            setSelectedFile(Pre_tapasFiles[0]); // Default to first file
        }
    ...
    const handleFeedbackSubmit = (rating, comment) => {
        ...
        localStorage.setItem("Pre_tapasFeedback", JSON.stringify(updatedFeedback));
    ...
    return (
        <div className="flex h-screen bg-gray-50 text-gray-800">
            ...
            <div className="w-64 bg-gray-800 text-white p-4 border-r border-gray-700 overflow-y-auto">
                <h2 className="text-xl font-bold mb-6 px-2">TAPAS Resources</h2>
                <nav className="space-y-2">
                    {Pre_tapasFiles.map(file => (
                        <button
                            key={file.id}
